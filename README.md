...
2. Сборка образов и запуск контейнеров приложений в Docker:

• Запустите контейнеры приложений (главного и сервиса платежей), запустив скрипт из файла `docker-compose.yml`

3. Доступ к приложению:

   • Откройте браузер и перейдите по адресу http://localhost:8180, чтобы получить доступ к витрине интернет-магазина.
   • Эндпоинт сервиса платежей http://localhost:8280.
